...
public class ActiveMichiganApiApplication {
	...
	public org.springframework.boot.CommandLineRunner seedActivities(
		...
		return args -> {
			...
			AppUser admin = users.findByEmailIgnoreCase("admin@activemichigan.local").orElse(null);
			...
			sleepingBearHike.setUser(admin);
			...
			mackinacIslandBike.setUser(admin);
			...
			isleRoyalePaddle.setUser(admin);
			...
			boyneMountainSki.setUser(admin);
			...
			lansingCapitalRun.setUser(admin);
			...
			muskegonLakeBike.setUser(admin);
			...
			tahquamenonFallsHike.setUser(admin);
			...
			crystalMountainSki.setUser(admin);
			...
			auSableRiverPaddle.setUser(admin);
			...
			copperHarborBike.setUser(admin);
			...
			picturedRocksHike.setUser(admin);
			...
			suttonsBayPaddle.setUser(admin);
			...
			grandHavenVolleyball.setUser(admin);
			...
			houghtonLakeSnowmobile.setUser(admin);
			...
			porcupineMountainsHike.setUser(admin);
